<?php 
/*
add_action( 'admin_menu', 'create_menu_report' );
include('bank-report.php');
include('credit-report.php');
include('paypal-report.php');
include('summary.php');

    function getPaymentDate($order_id){
      global $wpdb;
      $SQL = "SELECT  *  FROM `wp_payment` WHERE `order_id` = '".$order_id."'";
    ...
    function randerReport()
{
    ...
    <div class="main_container">
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">รายงานการสั่งซื้อคอร์ส <span class="label label-info">ทั้งหมด</span>
                     <?php
               ...
               <table class="table table-hover">
                  ...
                  <?php 
                    ...
                    if($key == '_learn_press_order_items'){        
                        ...
                        echo '<td>'.learn_press_payment_method_from_slug($result->ID).'</td>';
    ...
    <?php $url = get_site_url().'/wp-admin/admin.php?page=courses-report/'; ?>
     <script>
       jQuery(function(){
