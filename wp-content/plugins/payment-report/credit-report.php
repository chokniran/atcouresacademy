...
add_action( 'admin_menu', 'create_menu_credit_report' );
    
    function create_menu_credit_report(){
       add_submenu_page( 
        'courses-report', 
        'Credit', 
        'Credit',
    ...
    <div class="main_container">
        <div class="panel panel-success">
            ...
            <h3 class="panel-title">รายงานการสั่งซื้อคอร์ส <span class="label label-info">บัตรเครดิต</span>
                     <?php
              ...
              <div class="row">
               ...
               <table class="table table-hover">
                  ...
                  foreach( $results as $result ) {
                     ...
                     if($payment == "ชำระเงินผ่านบัตรเครดิต" ){
                     $key = $result->meta_key;
                   ...
                   ?>
                         ...
                         <td><?php echo $result->post_modified ?></td>
    ...
    <?php $url = get_site_url().'/wp-admin/admin.php?page=credit-report/'; ?>
     <script>
       jQuery(function(){
