...
add_action( 'admin_menu', 'create_menu_paypal_report' );
    
    function create_menu_paypal_report(){
       add_submenu_page( 
        'courses-report', 
        'Paypal', 
        'Paypal',
    ...
    <div class="main_container">
        <div class="panel panel-success">
            ...
            <h3 class="panel-title">รายงานการสั่งซื้อคอร์ส <span class="label label-info">Paypal</span>
                     <?php
    ...
    <?php $url = get_site_url().'/wp-admin/admin.php?page=paypal-report/'; ?>
     <script>
       jQuery(function(){
