...
?>
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:block;"'; ?>>
	...
	<p class="form-row">
		...
		<a  href="<?php get_site_url()?>/account/?action=register" class="button"><?php esc_attr_e( 'Register', 'woocommerce' ); ?></a>
	...
	<?php do_action( 'woocommerce_login_form_end' ); ?>
	    <div class="facebook-login _checkout"> 
