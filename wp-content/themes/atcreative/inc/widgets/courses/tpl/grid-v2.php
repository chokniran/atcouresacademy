					...
					<div class="thim-course-content">
						...
						<div class="course-meta">
							...
							<?php thim_course_ratings_count(); ?>
								...
								<?php $soon = get_post_meta( $post->ID, 'message_soon', true );  
								  if(!empty($soon)){
									?>
								...
								<?php else: $price = learn_press_format_price( $course->get_price(), true ); ?>
									  <?php $fullprice = get_post_meta( $post->ID, 'full_price', true );
										 if(!empty($fullprice)){
											 ?>
											  <div class="value sale_price" itemprop="price" content="<?php echo esc_attr( $price ); ?>">
													<?php echo esc_html( $price ); ?>
											  </div>
											  <div class="fullprice"><?php echo get_post_meta( $post->ID, 'full_price', true );?><?php echo learn_press_get_currency_symbol(); ?></div>
											 <?php
										 }else{
											?>
